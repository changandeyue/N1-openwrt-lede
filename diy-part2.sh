...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='libra-N1'' package/lean/default-settings/files/zzz-default-settings
...
sed -i "s/OpenWrt /libra/g" package/lean/default-settings/files/zzz-default-settings
...
sed -i 's/ssid=OpenWrt/ssid=libra/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh

# 修改默认wifi密码key为123456
#sed -i 's/key=password/key=123456/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
